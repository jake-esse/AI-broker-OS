...
from intake_graph import GState, classify, ask_more, ack, route_after_classify, detect_freight_complexity
...
class EmailIntakeService:
    ...
    async def _normalize_file_email(self, email_data: Dict[str, Any]) -> NormalizedEmail:
        ...
        from intake_graph import parse_email_with_headers
    ...
    async def _handle_missing_info_response(self, email: NormalizedEmail, 
        ...
        """
        try:
            from handle_missing_info_response import handle_missing_info_response
