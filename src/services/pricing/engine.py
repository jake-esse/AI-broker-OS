# --------------------------- src/services/pricing/engine.py ----------------------------
"""
...
def main():
    ...
    USAGE:
        python src/services/pricing/engine.py [load_id]
        python src/services/pricing/engine.py --test
    """
    ...
    if len(sys.argv) > 1 and sys.argv[1] == "--test":
        ...
        print("Usage: python src/services/pricing/engine.py [load_id]")
        print("   or: python src/services/pricing/engine.py --test")
