...
# ─── Local imports ──────────────────────────────────────────────────────
from src.services.email.classifier import (
    EmailIntent, 
...
from src.agents.intake.graph import agent as intake_agent
from src.agents.intake.pdf_processor import build_pdf_intake_agent
...
def main():
    ...
    USAGE:
        python src/agents/unified/intake.py <email.eml>
        python src/agents/unified/intake.py --test
    ...
    if len(sys.argv) < 2:
        print("Usage: python src/agents/unified/intake.py <email.eml>")
        print("   or: python src/agents/unified/intake.py --test")
        sys.exit(1)
