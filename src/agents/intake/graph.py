...
def ack(state: GState) -> Dict[str, Any]:
    ...
    load_data["ai_notes"] = "Processed by src/agents/intake/graph.py LangGraph agent"
...
def main() -> None:
    ...
    if len(sys.argv) != 2:
        print("Usage: python src/agents/intake/graph.py path/to/email.eml")
        sys.exit(1)
