...
def main():
    ...
    USAGE OPTIONS:
    1. python quotecollector_graph.py --test
       - Uses built-in test email
    2. python quotecollector_graph.py <email_file>
    ...
    """
    if len(sys.argv) < 2:
        print("Usage: python quotecollector_graph.py <sample_email_file>")
        print("   or: python quotecollector_graph.py --test")
        sys.exit(1)
