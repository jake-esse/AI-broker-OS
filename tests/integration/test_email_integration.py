...
try:
    ...
    from src.services.email.intake import EmailIntakeService, NormalizedEmail, EmailSource, ProcessingContext
    from src.services.email.imap import IMAPPollingService
...
class TestOAuthService:
    ...
    @patch('src.services.email.oauth.requests.post')
